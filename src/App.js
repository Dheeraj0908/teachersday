...
function Jumbo() {
  ...
  return (
    <group ref={ref}>
      <Text hAlign="right" position={[-20, 13, 0]} children="HAPPY" />
      <Text hAlign="right" position={[-20, 6.5, 0]} children="TEACHERS" />
      <Text hAlign="right" position={[-20, 0, 0]} children="DAY" />
      <Text hAlign="right" position={[0, 0, 0]} children="FROM" />
      <Text hAlign="right" position={[-20, -6.5, 0]} children="BTECH" />
      <Text hAlign="right" position={[-20, -13, 0]} children="5SEM" />
    </group>
  )
}
...
function App() {
 ...
 <footer>
  ...
  Made By Dheeraj Choudhury And Akash Kumar
    </h1>
